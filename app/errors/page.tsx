      ...
      <div style={{
        ...
        {error && (
          <>
            ...
            {/* Product + channel */}
            <div style={{ background: '#f8f4ec', borderRadius: '8px', padding: '14px 16px', marginBottom: '24px' }}>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Affected products */}
        <div style={{ background: '#f8f4ec', borderRadius: '8px', padding: '12px 14px', marginBottom: '20px', maxHeight: '160px', overflowY: 'auto' }}>
