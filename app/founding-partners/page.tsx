...
const TIERS: Tier[] = [
  {
    ...
    channels: '1 channel',
    monthly:  { USD: 149, GBP: 119, EUR: 135, AUD: 225, CAD: 199 },
    founding: { USD:  99, GBP:  79, EUR:  89, AUD: 149, CAD: 129 },
    features: ['Up to 500 listings', 'Feed health scoring', 'True profit dashboard', 'Email support'],
  },
  {
    name: 'Growth',
    desc: 'Operators at 100k–500k/mo GMV running 3–5 marketplaces.',
    channels: '3 channels',
    monthly:  { USD: 349, GBP: 279, EUR: 319, AUD: 529, CAD: 469 },
    founding: { USD: 249, GBP: 199, EUR: 229, AUD: 379, CAD: 339 },
    features: ['Unlimited listings', 'AI listing optimisation', 'Feed rules engine', 'Priority support'],
  },
  {
    name: 'Scale',
    desc: 'Plus merchants at 500k+/mo GMV selling on every marketplace.',
    channels: '5 channels',
    monthly:  { USD: 799, GBP: 639, EUR: 729, AUD: 1199, CAD: 1079 },
    founding: { USD: 599, GBP: 479, EUR: 539, AUD:  899, CAD:  799 },
    features: ['Autopilot AI agent', 'Real-time inventory sync', 'Full ML analytics', 'Dedicated account manager'],
  },
]
