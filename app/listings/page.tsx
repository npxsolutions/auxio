              ...
              {listingViewRows.map((row, i) => {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.background = 'rgba(232,134,63,0.10)' }}
              ...
              {paged.map((listing, i) => {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={e => { if (!isSelected && selectedListing?.id !== listing.id) (e.currentTarget as HTMLDivElement).style.background = 'rgba(232,134,63,0.10)' }}
      ...
      {someSelected && (
        <div style={{
          ...
          <button
            ...
            style={{ padding: '6px 12px', background: 'rgba(232,134,63,0.10)', color: '#c5d5f5', border: '1px solid rgba(232,134,63,0.10)', borderRadius: '2px', fontSize: '12px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' }}
          >
            Enrich with AI
          </button>
          ...
          <div style={{ position: 'relative' }}>
            <button
              ...
              style={{ padding: '6px 12px', background: 'rgba(232,134,63,0.10)', color: '#c5d5f5', border: '1px solid rgba(232,134,63,0.10)', borderRadius: '2px', fontSize: '12px', fontWeight: 600, cursor: bulkPublishing ? 'wait' : 'pointer', fontFamily: 'inherit' }}
            >
