    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#fff', color: '#0f172a' }}>
      ...
      <article style={{ maxWidth: '760px', margin: '0 auto', padding: '64px 48px 96px' }}>
        ...
        <div style={{ background: '#ede9fe', borderRadius: '10px', padding: '24px', marginTop: '24px', marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#4c1d95', margin: '0 0 16px', lineHeight: 1.6 }}>Fulcra pulls in real fee data from your channels and calculates true net profit automatically. Most sellers discover their margin is 15–30% lower than they thought — and know exactly which listings to fix.</p>
