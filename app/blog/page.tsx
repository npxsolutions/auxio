...
export const metadata: Metadata = {
  title: 'Blog — Multichannel Selling Guides for Global Sellers | Palvento',
...
const POSTS = [
  {
    ...
    excerpt: 'Palvento, Linnworks, Brightpearl, ChannelAdvisor, Feedonomics, and Veeqo — compared honestly. Real pricing, real feature gaps, and who each tool is actually built for.',
    date: '13 April 2026',
    readTime: '12 min',
    featured: true,
  },
  ...
  },
  {
    ...
    excerpt: 'Comparing Palvento, Linnworks, ChannelAdvisor, Brightpearl, and Feedonomics on price, features, and support. An honest review from sellers who\'ve used all of them.',
    date: '20 March 2026',
    readTime: '11 min',
    featured: false,
  },
