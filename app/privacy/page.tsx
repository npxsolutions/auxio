  ...
  return (
    ...
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '100px 48px 80px' }}>
      ...
      <p style={{ marginBottom: '32px' }}>
        Meridia ("we", "our", "us") is operated by NPX Solutions. This policy explains what data we collect, why we collect it, and how we use it. If you have questions, contact us at <a href="mailto:info@npx-solutions.com" style={{ color: '#191919' }}>info@npx-solutions.com</a>.
      </p>
      ...
      <Section title="1. Who we are">
        <p>Meridia is a multi-channel product listing management platform that connects ecommerce sellers with marketplaces including Shopify, eBay, and Amazon. We are based in the United Kingdom.</p>
      </Section>
      ...
      <Section title="2. Data we collect">
        ...
        <p><strong>Product and listing data</strong> — titles, descriptions, prices, images, and inventory levels that you enter or import into Meridia.</p>
        ...
        <p><strong>Usage data</strong> — pages visited, features used, and actions taken within the Meridia dashboard, collected to improve the product.</p>
      ...
      <Section title="3. How we use your data">
        <ul style={{ paddingLeft: '20px' }}>
          <li>To operate the Meridia service — publish listings, sync inventory, and generate AI-optimised content on your behalf</li>
      ...
      <Section title="4. Third-party services">
        <p>Meridia integrates with the following third-party services, each governed by their own privacy policies:</p>
        <ul style={{ paddingLeft: '20px' }}>
      ...
      <Section title="5. eBay data use">
        <p>When you connect your eBay account, Meridia requests access to manage your inventory, listings, and fulfilment data. This access is used solely to:</p>
        <ul style={{ paddingLeft: '20px' }}>
      ...
      <Section title="8. Cookies">
        <p>Meridia uses session cookies for authentication (managed by Supabase) and no third-party tracking cookies. We do not use advertising cookies or cross-site tracking.</p>
      </Section>
      ...
      <Section title="10. Changes to this policy">
        <p>We may update this policy from time to time. We will notify you by email if we make material changes. Continued use of Meridia after changes are posted constitutes acceptance.</p>
      </Section>
