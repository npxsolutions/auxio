...
const ASSETS = [
  ...
  'Comparison decks — Palvento versus the four most-asked competitors.',
...
const FAQ = [
  ...
  { q: 'Can I run paid ads on the Palvento brand?',    a: 'No brand bidding on Google or Bing. Newsletters, YouTube pre-roll, programmatic display, and organic social are all fair game.' },
  ...
  return (
    <form onSubmit={onSubmit} style={{ marginTop: 32, display: 'grid', gap: 16, background: C.surface, border: `1px solid ${C.ruleSoft}`, borderRadius: 18, padding: 32, maxWidth: 720 }}>
      ...
      <div>
        ...
        <textarea id="about" name="about" rows={4} style={{ ...fieldInput, resize: 'vertical', fontFamily: 'inherit' }} placeholder="Who reads or watches you? Why does Palvento fit?" />
      </div>
