...
export const metadata: Metadata = {
  title: 'Meridia vs Baselinker — Global platform vs regional alternative (2026)',
  description: 'Baselinker is a strong regional tool for Central/Eastern European sellers. Meridia is the global multichannel operations platform — see how they compare on pricing, AI, profit tracking, and support.',
  keywords: ['Baselinker alternative', 'Baselinker vs Meridia', 'Baselinker alternative 2026', 'global multichannel software', 'international commerce operations platform'],
}

const COMPARISON = [
  { feature: 'True profit tracking (after all fees)', auxio: true, bl: false, note: '' },
  { feature: 'AI listing writer', auxio: true, bl: false, note: '' },
  { feature: 'Global multichannel coverage', auxio: true, bl: 'partial', note: 'Baselinker is Poland-first; Meridia is built for sellers worldwide' },
...
const REASONS = [
  {
    ...
    desc: 'Baselinker tracks orders. Meridia tracks profit. We deduct eBay fees, Amazon referral fees, shipping costs, packaging, and COGS on every order so you see real margin — not just turnover.',
  },
  {
    title: 'You sell globally, not just in one region',
    desc: 'Baselinker is Poland-first and strongest in Central/Eastern Europe. Meridia is built for global multichannel sellers from day one — Amazon US/UK/DE/AU, eBay worldwide, Shopify, OnBuy, TikTok Shop, plus multi-currency billing in USD, GBP, EUR, AUD or CAD.',
  },
  {
    title: 'You want AI that actually helps',
    desc: 'Baselinker has basic automation. Meridia has an AI agent that writes channel-specific listings, spots underperforming products, recommends actions, and executes them — with your approval.',
  },
  {
    title: 'You\'re growing and want to add channels fast',
    desc: 'Baselinker\'s feed management is basic. Meridia\'s rule engine lets you transform titles, remap categories, and create channel-specific variants without touching a spreadsheet.',
  },
]
    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#ffffff', color: '#0f172a' }}>
      ...
      <div style={{ paddingTop: '100px', paddingBottom: '64px', background: '#fafaf9', borderBottom: '1px solid #f1f1ef' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 48px', textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: '48px', fontWeight: 800, letterSpacing: '-0.03em', lineHeight: 1.15, marginBottom: '20px', color: '#0f172a' }}>
            Meridia vs Baselinker
          </h1>
          <p style={{ fontSize: '18px', color: '#64748b', lineHeight: 1.7, marginBottom: '32px' }}>
            Baselinker is a strong regional tool, especially for sellers in Poland and Central/Eastern Europe. Meridia is the global commerce operations platform — built for multichannel sellers worldwide who want to understand their profit, not just process their orders.
          </p>
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
            <Link href="/signup" style={{ padding: '13px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #5b52f5, #7c6af7)', color: 'white', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>Try Meridia free →</Link>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '64px 48px 0' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
          <div style={{ padding: '28px', background: 'rgba(91,82,245,0.04)', border: '2px solid #5b52f5', borderRadius: '14px' }}>
            <div style={{ fontSize: '13px', fontWeight: 700, color: '#5b52f5', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '12px' }}>Choose Meridia if…</div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
            <thead>
              <tr style={{ background: '#0f172a' }}>
                ...
                <th style={{ padding: '14px 20px', textAlign: 'center', fontWeight: 700, color: '#a3e635', fontSize: '13px' }}>Meridia</th>
      ...
      <div style={{ background: '#fafaf9', borderTop: '1px solid #f1f1ef', padding: '80px 48px' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '28px', fontWeight: 800, letterSpacing: '-0.02em', marginBottom: '40px', color: '#0f172a' }}>Why multichannel sellers switch from Baselinker to Meridia</h2>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
            {REASONS.map(r => (
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '80px 48px' }}>
        ...
        <p style={{ fontSize: '15px', color: '#64748b', marginBottom: '32px', lineHeight: 1.6 }}>
          Baselinker prices by orders processed, which can get expensive as you scale. Meridia prices by plan — predictable monthly cost, no surprise bills when you have a good month.
        </p>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
          <div style={{ padding: '28px', border: '2px solid #5b52f5', borderRadius: '14px', background: 'rgba(91,82,245,0.03)' }}>
            <div style={{ fontSize: '13px', fontWeight: 700, color: '#5b52f5', marginBottom: '8px' }}>Meridia</div>
