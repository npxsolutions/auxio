...
const COMPARISON = [
  ...
  { feature: 'True net P&L tracking',       palvento: true,                 ca: false,                 highlight: false },
  { feature: 'Demand forecasting',          palvento: true,                 ca: false,                 highlight: false },
  { feature: 'Purchase orders',             palvento: true,                 ca: false,                 highlight: false },
  { feature: 'AI listing optimisation',     palvento: true,                 ca: 'RithumIQ (enterprise)', highlight: false },
  { feature: 'Advertising (PPC) tracking',  palvento: true,                 ca: true,                  highlight: false },
  { feature: 'Developer API + webhooks',    palvento: true,                 ca: true,                  highlight: false },
  { feature: 'eBay integration',            palvento: true,                 ca: true,                  highlight: false },
  { feature: 'Amazon integration',          palvento: true,                 ca: true,                  highlight: false },
  { feature: 'Shopify integration',         palvento: true,                 ca: true,                  highlight: false },
  { feature: 'Annual contract required',    palvento: false,                ca: 'Yes',                 highlight: false },
]
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#ffffff', color: '#0b0f1a' }}>
      ...
      <nav style={{ borderBottom: '1px solid #e2e8f0', padding: '0 48px', height: '58px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, background: '#fff', zIndex: 50 }}>
        <Link href="/" style={{ fontWeight: 700, fontSize: '15px', color: '#0b0f1a', textDecoration: 'none', letterSpacing: '-0.02em' }}>Palvento</Link>
      ...
      <section style={{ maxWidth: '760px', margin: '0 auto', padding: '80px 48px 60px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: '20px' }}>
          ...
          <span style={{ color: '#e8863f' }}>Palvento is built for multichannel sellers like you.</span>
        </h1>
        <p style={{ fontSize: '18px', color: '#475569', lineHeight: 1.7, marginBottom: '36px' }}>
          ChannelAdvisor (now Rithum) is a powerful commerce network — but it starts at $2,500+/mo, requires months of onboarding, and is priced for enterprise brands managing millions in GMV. Palvento gives multichannel sellers worldwide enterprise-level operations at a fraction of the cost, live in minutes.
        </p>
      ...
      <section style={{ maxWidth: '860px', margin: '0 auto', padding: '0 48px 80px' }}>
        <div style={{ border: '1px solid #e2e8f0', borderRadius: '12px', overflow: 'hidden' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', background: '#f8fafc', borderBottom: '1px solid #e2e8f0', padding: '12px 20px', fontSize: '12px', fontWeight: 700, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.06em', gap: '8px' }}>
            <span>Feature</span><span style={{ textAlign: 'center', color: '#e8863f' }}>Palvento</span><span style={{ textAlign: 'center' }}>ChannelAdvisor</span>
          </div>
      ...
      <section style={{ maxWidth: '600px', margin: '0 auto', padding: '0 48px 80px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '16px', color: '#475569', lineHeight: 1.7, marginBottom: '32px' }}>
          ChannelAdvisor makes sense when you're managing $10M+ GMV and need a managed service. For multichannel sellers who want control, transparency, and a platform that grows with them — Palvento is built for you.
        </p>
        <Link href="/signup" style={{ display: 'inline-block', padding: '14px 32px', borderRadius: '8px', background: '#e8863f', color: '#fff', fontSize: '15px', fontWeight: 600, textDecoration: 'none' }}>
