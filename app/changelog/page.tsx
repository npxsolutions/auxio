...
const ENTRIES: Entry[] = [
  ...
  },
  {
    ...
    body: 'Header `X-Fulcra-Signature-V1` replaces `X-Fulcra-Signature`. The old header continues to send for 90 days alongside the new one. Update your verifier before 2026-06-04.',
  },
  {
