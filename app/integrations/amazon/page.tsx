...
const FEATURES = [
  { icon: '🔄', title: 'List once, publish everywhere', desc: 'Create a product in Auxio and publish to Amazon, eBay, Shopify, and OnBuy simultaneously. One update, all channels.' },
  { icon: '📊', title: 'Amazon fee-aware profit', desc: 'Referral fees, FBA fulfilment, advertising spend — Auxio deducts them all so you see actual margin per ASIN, not just revenue.' },
      ...
      <div style={{ background: '#09090b', paddingTop: '100px', paddingBottom: '80px' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 48px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '20px', color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, marginBottom: '40px', maxWidth: '680px', margin: '0 auto 40px' }}>
            Stop switching between Seller Central and eBay. Manage every channel, see true profit on every order, and let AI optimise your listings — all from Auxio.
          </p>
