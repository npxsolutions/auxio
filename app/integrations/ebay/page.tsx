...
export const metadata: Metadata = {
  title: 'eBay Listing Software for Global Sellers | Meridia',
  description: 'Connect your eBay store to Meridia and list products in minutes. Sync inventory, track true profit, and use AI to write better listings — built for eBay sellers worldwide, across eBay.com, eBay.co.uk, eBay.de, eBay.com.au and more.',
...
const STEPS = [
  ...
  { n: '2', title: 'Import your listings', desc: 'Meridia pulls in your existing eBay listings, prices, and stock levels automatically. Your data stays intact.' },
...
const FEATURES = [
  ...
  { icon: '⚠️', title: 'Error detection', desc: 'Meridia watches your eBay listings 24/7 and flags ended listings, policy violations, and suppressed items before they cost you sales.' },
...
const FAQS = [
  { q: 'Which eBay marketplaces does Meridia support?', a: 'All major eBay sites — eBay.com (US), eBay.co.uk, eBay.de, eBay.fr, eBay.it, eBay.es, eBay.com.au, eBay.ca and more. We handle region-specific categories, sales tax / VAT calculation, and carrier integrations for each market (USPS, Royal Mail, DHL, Australia Post, Canada Post).' },
  { q: 'Will Meridia interfere with my existing eBay listings?', a: 'No. When you connect, we read your existing listings and import them. We only make changes when you explicitly tell us to — we never modify or end listings without your instruction.' },
  ...
  { q: 'Can I use Meridia just for eBay and nothing else?', a: 'Absolutely. Many sellers start with eBay only and expand to other channels over time. There is no requirement to connect multiple channels.' },
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#ffffff', color: '#0f172a' }}>
      ...
      <div style={{ background: '#09090b', padding: '80px 48px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, marginBottom: '32px' }}>
            Most eBay sellers think they're making 20% margin. After eBay final value fees (10–15%), payment processing (2.9%), shipping, packaging, and COGS — the real number is often half that. Meridia shows you the actual figure on every order.
          </p>
      ...
      <div style={{ background: '#fafaf9', padding: '80px 48px', borderTop: '1px solid #f1f1ef' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '32px', fontWeight: 800, textAlign: 'center', letterSpacing: '-0.02em', marginBottom: '12px', color: '#0f172a' }}>How Meridia compares for eBay sellers</h2>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
              <thead>
                <tr style={{ background: '#0f172a', color: 'white' }}>
                  ...
                  <th style={{ padding: '14px 20px', textAlign: 'center', fontWeight: 700, color: '#a3e635' }}>Meridia</th>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginTop: '32px' }}>
            <Link href="/vs/linnworks" style={{ fontSize: '14px', color: '#5b52f5', textDecoration: 'none', fontWeight: 500 }}>Meridia vs Linnworks →</Link>
            <span style={{ color: '#e2e8f0' }}>|</span>
            <Link href="/vs/channelAdvisor" style={{ fontSize: '14px', color: '#5b52f5', textDecoration: 'none', fontWeight: 500 }}>Meridia vs ChannelAdvisor →</Link>
          </div>
        </div>
      </div>
