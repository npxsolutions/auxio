          ...
          <div data-tour="dashboard-orders" style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '12px', marginBottom: '12px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div style={{ ...CARD_STYLE, padding: '18px' }}>
                ...
                <div style={{ fontSize: '12px', color: '#6b6e87', marginBottom: '12px' }}>Value returned per £1 paid to Palvento</div>
                <div style={{ fontSize: '12px', color: '#9496b0', fontStyle: 'italic', lineHeight: 1.5 }}>
                  "Your bank lends your £1 deposit out 9 times. Palvento returns {(data?.leverageRatio ?? 0) > 0 ? data!.leverageRatio.toFixed(1) : '9.4'}× for every £1 you pay."
                </div>
              </div>
