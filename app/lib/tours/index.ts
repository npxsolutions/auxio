  ...
  dashboard: [
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          'More channels, more accurate net margin. eBay, Amazon, Shopify, Etsy, Walmart — link them once, Fulcra keeps them synced.',
        side: 'top',
      },
    },
    {
  ...
  listings: [
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          'Without cost prices, margin is a guess. Add them in bulk via CSV import, and every profit number in Fulcra becomes real.',
        side: 'bottom',
      },
    },
  ],
  channels: [
    {
      ...
      popover: {
        title: 'Live channels',
        description:
          'Every marketplace currently feeding orders, stock and fees into Fulcra. Test or sync any one on demand.',
        side: 'bottom',
      },
    },
    {
