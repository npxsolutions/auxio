...
export const EBAY_ERROR_MAP: MappedEbayError[] = [
  ...
  { code: 'LOCATION_REQUIRED', errorId: 25043, plainMessage: 'A merchant location must exist before publishing.', remediation: 'Palvento normally creates one automatically — try republishing.' },
  ...
  { code: 'DESCRIPTION_REQUIRED', errorId: 25060, plainMessage: 'A description is required.', remediation: 'Add a description in Shopify or in the Palvento editor.' },
  ...
  { code: 'AUTH_TOKEN_INVALID', errorId: 1001, match: /token.*(invalid|expired)/i, plainMessage: 'Your eBay connection has expired.', remediation: 'Reconnect eBay in Palvento → Channels.' },
  { code: 'INSUFFICIENT_PERMISSIONS', errorId: 1002, plainMessage: 'Your eBay account is missing required permissions.', remediation: 'Re-authorize Palvento and grant all requested scopes.' },
  { code: 'RATE_LIMITED', errorId: 2001, match: /rate limit|429/i, plainMessage: 'eBay temporarily throttled this request.', remediation: 'Palvento will retry automatically; no action needed.' },
