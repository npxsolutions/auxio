...
const QUOTES = [
  ...
  { metric: '$5,400', label: 'saved vs Linnworks · year', q: 'I knew we were profitable. I did not know we were 8% profitable. Auxio showed the real number.', who: 'Marcus L.', role: 'Electronics · US/UK/EU' },
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 40, background: 'rgba(243,240,234,0.86)', backdropFilter: 'blur(10px)', borderBottom: `1px solid ${C.rule}` }}>
        <div style={{ maxWidth: 1320, margin: '0 auto', padding: '14px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', color: C.ink }}>
            ...
            <span style={{ fontFamily: 'var(--font-display-v5), Georgia, serif', fontSize: 24, lineHeight: 1, letterSpacing: '-0.015em' }}>Auxio</span>
          </Link>
            ...
            <div style={{ maxWidth: 1100 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 56, alignItems: 'end', marginTop: 36 }}>
                <p style={{ fontSize: 18, lineHeight: 1.6, color: C.mutedDk, margin: 0, maxWidth: 620 }}>
                  Auxio is the operating system for global commerce — one ledger, one inventory, one truth across every marketplace, every currency, every region. The map below is live: orders settling right now, in {HUBS.length}+ markets, across {ARCS.length} active routes.
                </p>
      ...
      <section id="why" style={{ padding: '120px 32px', background: C.ink, color: C.bg }}>
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          ...
          <div style={{ marginTop: 64, padding: '32px 32px', borderLeft: `3px solid ${C.cobalt}`, background: 'rgba(29,95,219,0.08)', maxWidth: 920 }}>
            <div style={{ fontFamily: 'var(--font-mono), monospace', fontSize: 11, color: '#7BB7FF', letterSpacing: '0.18em', textTransform: 'uppercase', fontWeight: 700, marginBottom: 14 }}>Auxio · est. mmxxvi</div>
        ...
        <div style={{ maxWidth: 1320, margin: '0 auto', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48 }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
              ...
              <span style={{ fontFamily: 'var(--font-display-v5), Georgia, serif', fontSize: 22, letterSpacing: '-0.015em' }}>Auxio</span>
            </div>
