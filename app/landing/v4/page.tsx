...
// ── Testimonials ─────────────────────────────────────────────────────────────
const QUOTES = [
  { q: 'We were running five marketplaces from four browser tabs. Palvento collapsed it to one screen and a P&L we can actually trust.', who: 'Sarah T.', role: 'Founder · Apparel · 6 channels', metric: '+34%', label: 'net margin, 60 days' },
  { q: 'I knew we were profitable. I did not know we were 8% profitable. Palvento showed me the real number, then showed me the listings to fix.', who: 'Marcus L.', role: 'Operator · Electronics · US/UK/EU', metric: '$5,400', label: 'saved vs Linnworks (year)' },
...
export default function LandingV4() {
  ...
  return (
    ...
    >
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 40, background: 'rgba(241,235,223,0.92)', backdropFilter: 'blur(8px)', borderBottom: `1px solid ${C.rule}` }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '14px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24 }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', color: C.ink }}>
            <Mark size={22} />
            <span style={{ fontFamily: 'var(--font-display), Georgia, serif', fontSize: 22, fontWeight: 500, letterSpacing: '-0.02em', lineHeight: 1 }}>Palvento</span>
      ...
      <section style={{ position: 'relative', zIndex: 2, background: C.ink, color: C.paper, padding: '52px 32px', borderBottom: `1px solid ${C.ink}` }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 14, marginBottom: 28 }}>
            <span style={{ fontFamily: 'var(--font-mono), monospace', fontSize: 10.5, color: C.accent, letterSpacing: '0.22em', textTransform: 'uppercase' }}>The Palvento Index</span>
      ...
      <section style={{ position: 'relative', zIndex: 2, padding: '96px 32px', borderBottom: `1px solid ${C.rule}` }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '160px 1fr 1fr', gap: 56 }}>
          ...
          <div style={{ fontSize: 16, lineHeight: 1.7, color: C.mutedDk }}>
            ...
            <p style={{ margin: 0 }}>
              Palvento is the platform that does. One ledger. One inventory. One truth. Built from the operations layer up, not the listings layer down.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ── Why Palvento — incumbent comparison ────────────────────────────────── */}
      <section id="why" style={{ position: 'relative', zIndex: 2, padding: '96px 32px', borderBottom: `1px solid ${C.rule}` }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 14, marginBottom: 16 }}>
            <span style={{ fontFamily: 'var(--font-mono), monospace', fontSize: 10.5, color: C.accent, letterSpacing: '0.22em', textTransform: 'uppercase', fontWeight: 600 }}>Why Palvento</span>
            <div style={{ flex: 1, height: 1, background: C.rule }} />
          ...
          <div style={{ marginTop: 64, display: 'grid', gridTemplateColumns: '120px 1fr', gap: 32, alignItems: 'start' }}>
            <div style={{ borderTop: `2px solid ${C.accent}`, paddingTop: 18 }}>
              <div style={{ fontFamily: 'var(--font-mono), monospace', fontSize: 10, color: C.accent, letterSpacing: '0.18em', fontWeight: 700, textTransform: 'uppercase' }}>Palvento</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 48 }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                <Mark size={20} />
                <span style={{ fontFamily: 'var(--font-display), Georgia, serif', fontSize: 22, fontWeight: 500, letterSpacing: '-0.02em' }}>Palvento</span>
              </div>
