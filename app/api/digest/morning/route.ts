...
<title>Your Meridia Daily Digest</title>
</head>
...
<table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
    ...
    <tr>
      <td>
        <div style="display:inline-flex;align-items:center;gap:8px;">
          ...
          <span style="font-size:15px;font-weight:700;color:#0f172a;letter-spacing:-0.01em;">Meridia</span>
        </div>
      </td>
  ...
  <tr><td style="background:white;border-radius:16px;border:1px solid #e8e5df;overflow:hidden;">
    ...
    <tr><td style="padding:24px 36px;">
      ...
      <tr>
        <td>
          <a href="https://auxio-lkqv.vercel.app/dashboard" style="display:inline-block;background:#0f172a;color:white;text-decoration:none;border-radius:8px;padding:11px 20px;font-size:13px;font-weight:600;">Open dashboard →</a>
        </td>
        <td align="right">
          <a href="https://auxio-lkqv.vercel.app/agent" style="display:inline-block;border:1px solid #e8e5df;color:#1a1b22;text-decoration:none;border-radius:8px;padding:11px 20px;font-size:13px;font-weight:600;">AI insights →</a>
        </td>
      </tr>
      </table>
    </td></tr>
  ...
  <tr><td style="padding:20px 0;text-align:center;">
    <div style="font-size:12px;color:#c0bdb7;">
      You're receiving this because daily digests are enabled in your Meridia account.
      <br>
      <a href="https://auxio-lkqv.vercel.app/settings" style="color:#9b9ea8;text-decoration:none;">Manage preferences</a>
      &nbsp;·&nbsp;
      <a href="https://auxio-lkqv.vercel.app/unsubscribe?email=${encodeURIComponent(d.email)}&type=digest" style="color:#9b9ea8;text-decoration:none;">Unsubscribe</a>
    </div>
  </td></tr>
