...
const ASPECT_DESCRIPTIONS: Record<string, string> = {
  ...
  'Size':                            "The size of the item. Format varies by category — e.g. 'M', 'L', '32', '10 '",
  ...
  'Non-Domestic Product':            "Select Yes if the item was not originally manufactured for the  market",
