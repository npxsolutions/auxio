...
const FEATURES = [
  {
    ...
    body: 'Write a product listing one time and push it to eBay, Amazon, Shopify, TikTok Shop, and more — simultaneously, across every region you sell in. Fulcra handles format differences, title character limits, required attributes, and category mapping for every platform automatically.',
    bullets: [
  ...
  },
  {
    ...
    body: "Fulcra's AI Agent writes channel-specific titles, bullet points, and descriptions trained on each platform's ranking signals. eBay keywords, Amazon A9 bullet points, Shopify brand copy — generated in seconds, not hours.",
    bullets: [
  ...
  },
  {
    ...
    body: "Fulcra's Error Hub flags every issue blocking a listing from going live — missing images, title too long, required category attributes empty, price below minimum. Fix in one place, republish in one click.",
    bullets: [
    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#ffffff', color: '#0f172a' }}>
      ...
      <div style={{ paddingTop: '120px', paddingBottom: '80px', textAlign: 'center', background: 'linear-gradient(180deg, #fafafa 0%, #ffffff 100%)', borderBottom: '1px solid #f1f1ef' }}>
        ...
        <p style={{ fontSize: '18px', color: '#64748b', maxWidth: '560px', margin: '0 auto 32px', lineHeight: 1.6 }}>
          From first listing to every marketplace — Fulcra handles the complexity so you can focus on finding product.
        </p>
      ...
      <div style={{ background: '#0f172a', padding: '80px 48px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.5)', marginBottom: '32px' }}>Join sellers already using Fulcra to list faster, profit clearly, and grow without the chaos.</p>
