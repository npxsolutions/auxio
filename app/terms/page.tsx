    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#ffffff', color: '#0f172a' }}>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '100px 48px 80px' }}>
        ...
        <p style={{ fontSize: '15px', color: '#374151', lineHeight: 1.8, marginBottom: '32px' }}>
          These Terms of Service ("Terms") govern your use of Auxio, operated by NPX Solutions ("we", "our", "us"). By creating an account or using the Auxio platform, you agree to these Terms. If you do not agree, do not use the service.
        </p>

        <Section title="1. The service">
          <p>Auxio is a multi-channel product listing management and analytics platform. We provide tools to create, manage, and publish product listings across multiple sales channels, track profit and performance, and generate AI-assisted insights.</p>
        ...
        <Section title="2. Accounts">
          <p>You must be at least 18 years old and operate a legitimate business to create an Auxio account. You are responsible for maintaining the security of your account credentials and for all activity that occurs under your account.</p>
        ...
        <Section title="3. Subscriptions and billing">
          <p>Auxio offers paid subscription plans (Starter, Growth, Scale) and an Enterprise plan with custom pricing. Prices are shown inclusive of VAT where applicable.</p>
        ...
        <Section title="4. Acceptable use">
          <p>You agree not to use Auxio to:</p>
          <ul>
            ...
            <li>Resell or sublicense access to Auxio without our written permission</li>
        ...
        <Section title="5. Channel integrations">
          <p>By connecting a third-party channel (eBay, Amazon, Shopify, etc.), you authorise Auxio to act on your behalf to manage listings, inventory, and fulfilment data within that channel. You are solely responsible for compliance with each channel's own terms of service.</p>
        ...
        <Section title="6. AI-generated content">
          <p>Auxio uses AI to generate listing titles, descriptions, and recommendations. You are responsible for reviewing and approving AI-generated content before publishing. We do not guarantee that AI-generated content will comply with any particular marketplace's listing policies, be free of errors, or achieve any particular commercial outcome.</p>
          <p>AI-generated content is provided as a tool, not as professional or legal advice.</p>
        </Section>

        <Section title="7. Intellectual property">
          <p>You retain ownership of all product data, images, and content you upload to Auxio. By using the service, you grant us a limited licence to process, store, and display that content solely for the purpose of providing the Auxio service.</p>
          <p>The Auxio platform, software, branding, and documentation are owned by NPX Solutions. You may not copy, modify, or distribute them without our written consent.</p>
        </Section>

        <Section title="8. Data and privacy">
          <p>Our use of your data is governed by our <Link href="/privacy" style={{ color: '#5b52f5', textDecoration: 'none' }}>Privacy Policy</Link>, which forms part of these Terms. By using Auxio, you consent to the data practices described there.</p>
        </Section>
        ...
        <Section title="10. Warranties">
          <p>Auxio is provided "as is" and "as available". We do not warrant that the service will be uninterrupted, error-free, or secure. We make no warranties about the accuracy of AI-generated content or the performance of any sales channel integration.</p>
        ...
        <Section title="13. Changes to these terms">
          <p>We may update these Terms from time to time. We will notify you by email at least 14 days before material changes take effect. Continued use of Auxio after changes take effect constitutes acceptance of the new Terms.</p>
        </Section>
