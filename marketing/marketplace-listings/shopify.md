...
## Key features (4 bullets, each ≤80 chars)
1. Two-way Shopify sync with sub-minute latency.
2. Unified orders across every connected marketplace.
3. True profit per SKU including fees, shipping, and VAT.
...
3. Per-SKU profit breakdown.
4. Repricer rule editor with history.
5. Shopify sync detail view (highlight the install).

## Demo video (≤2 min, MP4, 1080p)
