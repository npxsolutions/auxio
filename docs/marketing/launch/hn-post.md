...
> **Show HN: Auxio – Commerce Operations Platform for multichannel sellers**
> *(71 chars)*

## Body (under 1500 chars)

> Hi HN — I&apos;m Nick, and this is Auxio.
>
...
>
> Auxio is the layer that closes the loop. Inventory, orders, forecasting, procurement, and true multi-currency settled P&L across Shopify, Amazon, eBay, TikTok Shop, Etsy, and more — in one schema, with one canonical SKU. Order-volume pricing, never a percentage of revenue (the current enterprise incumbents all charge a % and we think that&apos;s wrong on principle).
>
