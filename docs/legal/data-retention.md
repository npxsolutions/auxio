...
Palvento retains personal and operational data only as long as it is needed for
...
| Stripe payment tokens      | Handled by Stripe per their retention; Palvento holds tokens only while subscription is active | Contract |
